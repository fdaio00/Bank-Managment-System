...
sUsers ConvertUsersLinetoRecord(string Line, string Seperator = "#//#")
{
    ...
    User.Premissions = stoi(vUsersData[2]);
...
string ConvertUsersRecordToLine(sUsers User, string Seperator = "#//#")
{

    string  sUserRecords = "";

    sUserRecords += User.UserName+ Seperator;
    sUserRecords += User.Password+ Seperator;
    sUserRecords += User.Premissions;
...
sUsers ReadNewUser()
{
    ...
    /*cout << "Enter Premission? ";
    getline(cin, User.Premissions);*/
...
void PrintUsersRecordLine(sUsers User)
{
    ...
    cout << "| " << setw(40) << left << User.Premissions;
...
enum enManageusersMenueOptions { eListUsers = 1, eAddNewUsers = 2, eDeleteUser = 3, eUpdateUser = 4, eFindUsers = 5, enShowMainMenue = 6 };
enum enMainMenueOptions { eListClients = 1, eAddNewClient = 2, eDeleteClient = 3, eUpdateClient = 4, eFindClient = 5, eShowTransactionsMenue = 6, eShowMangeUsersMenue=7,eExit = 8 };
...
short ReadMangaeUsersMenuOption()
{
...
void ShowManageUsersMenue()
{
    ...
    cout << "\t[6] Main Menu.\n";
    cout << "===========================================\n";
    PerfromManageUsersMenueOption((enManageusersMenueOptions)ReadMangaeUsersMenuOption());
}
...
void PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
{
    ...
    case enMainMenueOptions::eShowTransactionsMenue:
        ...
        ShowTransactionsMenue();
        break; 
    case enMainMenueOptions::eShowMangeUsersMenue:
        system("cls");
        ShowManageUsersMenue();
        break;
...
bool IsUserNameAndPasswrodCorrect()
{
    string UserName; 
    string Password; 
    sUsers User;
...
{
    DisplayLoginScreen();
    if (IsUserNameAndPasswrodCorrect())
    {
        ShowMainMenue();
    }
